...
public class CarService
{
    ...
    private MapsClient mc;
    private PriceClient pc;
    ...
    public MapsClient getMc() { return mc;    }
    public void setMc(MapsClient mc) {        this.mc = mc;    }
    public PriceClient getPc() {        return pc;    }
    public void setPc(PriceClient pc) {        this.pc = pc;    }
    /**
    ...
    public Car findById(Long id) throws Exception
    {
        ...
        {
            Car returnCar = repository.findById(id).get();
            returnCar.setPrice(pc.getPrice(id));
            returnCar.setLocation(mc.getAddress(returnCar.getLocation()));
            return returnCar;
        }
        else
